...
const config: Config = {
  ...
  theme: {
    extend: {
      colors: {
        // Palette Bartellemy-Robinet - Professionnelle & Énergétique
        bleu: {
          DEFAULT: '#1E3A5F',
          50: '#EBF0F5',
          100: '#D7E1EB',
      ...
      boxShadow: {
        'pro': '0 4px 20px -5px rgba(30, 58, 95, 0.15)',
        'pro-lg': '0 10px 40px -10px rgba(30, 58, 95, 0.2)',
        'pro-xl': '0 20px 60px -15px rgba(30, 58, 95, 0.25)',
        'orange': '0 10px 40px -10px rgba(232, 93, 4, 0.3)',
      ...
      backgroundImage: {
        ...
        'gradient-pro': 'linear-gradient(135deg, #1E3A5F 0%, #2D4A73 50%, #1E3A5F 100%)',
        'gradient-warm': 'linear-gradient(135deg, #E85D04 0%, #F58737 50%, #E85D04 100%)',
